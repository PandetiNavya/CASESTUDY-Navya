...
namespace QuickTrade.Controllers
{
    ...
    public class SellersController : ControllerBase
    {
        ...
        [HttpPost("signup")]
        public async Task<ActionResult<Seller>> SignUp(Seller seller)
        {
            _context.Sellers.Add(seller);
            await _context.SaveChangesAsync();
        ...
        [HttpPost("login")]
        public async Task<ActionResult<Seller>> Login(SellerLoginModel model)
        {
            var seller = await _context.Sellers.FirstOrDefaultAsync(s => s.SellerEmail == model.SellerEmail && s.SellerPwd == model.SellerPwd);
